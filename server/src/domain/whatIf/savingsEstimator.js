...
export function estimateMoneySavings(templateId, modifiedInputs, inputPayload) {
  switch (templateId) {
    ...
    case 'reduce_ac_usage': {
      ...
      return Number.parseFloat((dailySavings * 30).toFixed(2));
    }
    ...
    case 'vegetarian_days': {
      ...
      return Number.parseFloat((daysInMonth * mealsPerDay * SAVINGS_MULTIPLIERS.food.meat_to_veg_per_meal).toFixed(2));
    }
