    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      ...
      <div className="lg:col-span-5 space-y-8">
        ...
        <section>
          ...
          <div className='bg-zinc-50 dark:bg-zinc-950/40 p-6 rounded-4xl border border-zinc-100 dark:border-zinc-800/50'>
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <button
                  ...
                  className={cn(
                    "flex flex-col items-center justify-center gap-2.5 p-3 rounded-2xl border-2 transition-all relative overflow-hidden",
                    theme === t.id
                ...
                >
                  {theme === t.id && (
                    <div className="absolute top-0 right-0 p-1.5 bg-primary text-white rounded-bl-lg">
            ...
            <p className="text-[10px] text-muted-foreground mt-4 text-center">
              Choose your dashboard's visual style.
            </p>
          </div>
        </section>
      </div>
      ...
      <div className="lg:col-span-7 space-y-8">
        ...
        <section>
          ...
          <div className='bg-zinc-50 dark:bg-zinc-950/40 p-8 rounded-4xl border border-zinc-100 dark:border-zinc-800/50'>
            <div className="grid gap-1.5">
              <Label>Email</Label>
              <div className="relative">
        ...
        <section>
          ...
          {isGoogleUser ? (
            <div className="flex items-start gap-4 p-5 rounded-[2rem] bg-zinc-50 dark:bg-zinc-950/40 border border-zinc-100 dark:border-zinc-800/50">
        ...
        <div className="pt-2 flex justify-end">
          <Button
            ...
            className="w-full sm:w-auto gap-2 font-bold h-11 px-10 rounded-2xl shadow-lg shadow-primary/20"
          >
