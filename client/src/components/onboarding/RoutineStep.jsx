...
const RoutineStep = ({ data, onChange }) => {
  const routines = [
    {
      value: 'offline_commute',
      label: 'Office Commute',
      icon: Building2,
      desc: 'Regular travel to a physical workplace',
    },
    {
      value: 'work_from_home',
      label: 'Work From Home',
      icon: Home,
      desc: 'Remote work with minimal commuting',
    },
    {
      value: 'hybrid',
      label: 'Hybrid Work',
      icon: Laptop,
      desc: 'Balance of office and remote work',
    },
    {
      value: 'college_commute',
      label: 'College/Uni',
      icon: GraduationCap,
      desc: 'Student life with campus commuting',
    },
  ];
